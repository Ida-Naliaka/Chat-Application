    ...
    const handleSubmit= async()=>{
      ...
      if(password.match(paswd)) {
        ...
        try {
          ...
          const{ data }= await axios.post("/api/auth", {name, email, password, pic}, config)
          toast({
  ...
  return (
    <VStack spacing='5px' color='black'>
      ...
      <FormControl id='password' isRequired>
        <FormLabel>Password [at least 7 characters; must contain at least one digit and a special character]</FormLabel>
        <InputGroup>
        <Input
